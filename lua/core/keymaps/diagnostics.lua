...
function M.setup()
	...
	keymap("n", "<leader>dp", vim.diagnostic.goto_prev, vim.tbl_extend("force", opts, { desc = "上一个诊断" }))
	keymap("n", "<leader>dn", vim.diagnostic.goto_next, vim.tbl_extend("force", opts, { desc = "下一个诊断" }))
